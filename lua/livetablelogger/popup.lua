...
function popup.create(what, vim_options, custom_opts)
 --pr(vim_options) 
  local bufnr
  ...
  local win_opts = { 
    ...
    col = vim_options.col,
    row = vim_options.row,
    width = vim_options.width,
    height = vim_options.height,
    style = vim_options.style,
  }

  if vim_options.win then win_opts.win = vim_options.win end
